...
from linkedin.user_agents import random_user_agent
from scrapy.conf import settings
from scrapy.spidermiddlewares.httperror import HttpErrorMiddleware, HttpError
from linkedin.helpers.network_manager import update_search_param_status
...
class SpiderClosingMiddleware(object):
    ...
    def spider_closed(cls, spider, reason):
        if reason == "Crawler Blocked 999 Error":
            ...
            while spider.requests_queue:
                ...
                if spider.name == "linkedin_person_profile" or spider.name == 'linkedin_company_profile':
    ...
    def process_spider_input(self, response, spider):
        if response.status == 999:
            if spider.name == "linkedin_person_profile" or spider.name == 'linkedin_company_profile':
                ...
                raise CloseSpider('Crawler Blocked 999 Error')
